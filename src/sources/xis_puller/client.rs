...
use crate::sources::util::xis_puller::client;
use crate::{
    ...
    sources::util::{
        http::HttpMethod,
        xis_puller::client::{
            build_url, call, default_interval, default_time_range, default_timeout,
            warn_if_interval_too_low, GenericPullerClientInputs, PullerClientBuilder,
        },
        xis_puller::vrl::{VrlDeserializerConfig, VrlDeserializerOptions},
    },
...
pub struct PullerConfig {
    ...
    /// The time range to pull data from
    #[serde(default = "default_time_range")]
    #[serde_as(as = "serde_with::DurationSeconds<u64>")]
    #[serde(rename = "time_range_secs")]
    #[configurable(metadata(docs::human_name = "Time Range"))]
...
impl_generate_config_from_default!(PullerConfig);

#[async_trait::async_trait]
#[typetag::serde(name = "xis_puller")]
impl SourceConfig for PullerConfig {
    async fn build(&self, cx: SourceContext) -> Result<sources::Source> {
        ...
        let context = PullerClientContext {
            decoder,
            log_namespace,
        };
...
#[derive(Clone)]
pub struct PullerClientContext {
    pub decoder: Decoder,
    pub log_namespace: LogNamespace,
}

impl PullerClientContext {
...
impl PullerClientBuilder for PullerClientContext {
...
impl client::PullerClientContext for PullerClientContext {
